...
if __name__ == '__main__':
    ...
    pose_target_1 =  [ 0.12, 0.0, 0.05, 0.0, math.pi/2.0, 0.0 ] # [ x, y, z, r, p, y ]
    ...
    # # Pose 3 Z:-0.07[m]
    # rospy.loginfo( "Starting Pose 3 Z:-0.07[m]")
    # pose_target_3.position.z -= 0.07    
    # group.set_joint_value_target(pose_target_3, True )
    # group.go()    
    # rospy.sleep(0.1)
    # pose_current = group.get_current_pose()
